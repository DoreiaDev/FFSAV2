...
//        die();
    ...
    public function ListCompetitionByOfficial() {
        $query = 'SELECT `0108asap_officialregistrationcompetition`.`id` AS `idOfficialRegistrationCompetition`,'
                ...
                . '`0108asap_officialregistrationcompetition`.`id_0108asap_SportEvents` AS `IdSportEventsCompet`,   `0108asap_sportsevents`.`NameOfTheTest`, '
                ...
                . '`0108asap_typeofcompetition`.`id` AS `IdTypeOfCompetitonByCompetition`, '
    ...
    public function ListRalyByOfficial() {
        $query = 'SELECT `0108asap_officialregistrationcompetition`.`id` AS `idOfficialRegistrationCompetition`, '
                ...
                . '`RegistrationDate`, `0108asap_officialregistrationcompetition`.`id_0108asap_SportEvents` AS `IdSportEventsRally`, '
                ...
                . '`0108asap_typeofcompetition`.`TypeOfCompetiton`, '
                . '`0108asap_typeofcompetition`.`id` AS `IdTypeOfCompetitonByRally`, '
                . '`0108asap_functions`.`TypeOfLicence`, '
